test_that("rescale_f works", {
  ...
  expect_identical(rescale_f(mtcars, transform = list(log = "mpg"))$mpg,
                   log(mtcars$mpg))
  expect_identical(rescale_f(mtcars, transform = list(sqrt = c("mpg", "cyl")))$cyl,
                   sqrt(mtcars$cyl))
  ...
  expect_identical(rescale_f(mtcars, mtcars2, subtract = list(mean = "mpg"))$mpg,
